...
public class CreateChannel {
     ...
     */
    public AppUser getOrgAdmin(String adminName, String msp, 
            String pkFolderPath, String certFolderPath) {
     ...
     */
    public Enrollment getEnrollFromPath(String pkFolderPath, String certFolderPath) {
