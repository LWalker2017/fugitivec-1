...
public class CreateChannel {
    ...
    public static AppUser getOrgAdmin(String adminName, String msp, 
            String pkFolderPath, String certFolderPath) throws Exception {
     ...
     */
    public static Enrollment getEnrollFromPath(String pkFolderPath, String certFolderPath) throws Exception {
